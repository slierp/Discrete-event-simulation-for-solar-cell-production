...
class BatchTex(object):
    ...
    def __init__(self, env, _params = {}):   
        ...
        self.params = {}
        self.params['name'] = ""
        self.params['process_batch_size'] = 400
        ...
        self.batchprocesses = {}
        self.batchprocesses[0] = BatchProcess(self.env,"tex0",self.params['process_batch_size'],self.params['process_time'])
        self.batchprocesses[1] = BatchProcess(self.env,"tex1",self.params['process_batch_size'],self.params['process_time'])
        self.batchprocesses[2] = BatchProcess(self.env,"tex2",self.params['process_batch_size'],self.params['process_time'])
        self.batchprocesses[3] = BatchProcess(self.env,"rinse0",self.params['process_batch_size'],self.params['rinse_time'])
        self.batchprocesses[4] = BatchProcess(self.env,"neutr",self.params['process_batch_size'],self.params['neutr_time'])
        self.batchprocesses[5] = BatchProcess(self.env,"rinse1",self.params['process_batch_size'],self.params['rinse_time'])
        self.batchprocesses[6] = BatchProcess(self.env,"dry0",self.params['process_batch_size'],self.params['dry_time'])
        self.batchprocesses[7] = BatchProcess(self.env,"dry1",self.params['process_batch_size'],self.params['dry_time'])
        self.batchprocesses[8] = BatchProcess(self.env,"dry2",self.params['process_batch_size'],self.params['dry_time'])
        ...
        self.transport0 = BatchTransport(self.env,batchconnections,"transport0",self.params['process_batch_size'])
        ...
        self.transport1 = BatchTransport(self.env,batchconnections,"transport1",self.params['process_batch_size'])
        ...
        self.transport2 = BatchTransport(self.env,batchconnections,"transport2",self.params['process_batch_size'])
